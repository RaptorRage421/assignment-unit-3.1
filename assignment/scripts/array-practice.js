...
let favoriteFoods = ['Fettuccine Alfredo', 'Fried Chicken', 'Pizza', 'Mike and Ike', 'Tequila']
...
let entree = 'French Onion Soup';
favoriteFoods.unshift(entree);
console.log(`Added an entree to the beginning of the meal: ${favoriteFoods}`)
...
const index = 1;
const newValue = 'Tourmaline';
gems[index] = newValue;
console.log('New list of Gems:', gems);
